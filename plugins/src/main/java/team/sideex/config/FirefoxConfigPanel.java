...
public class FirefoxConfigPanel extends JPanel {
    ...
    public void configure(TestElement element) {
        if (element instanceof FirefoxConfig) {
            FirefoxConfig firefoxConfig = (FirefoxConfig) element;
            browserArgs.setText(firefoxConfig.getBrowserAdditionalArgs());
        }
    }
    ...
    public void modifyTestElement(TestElement element) {
        if (element instanceof FirefoxConfig) {
            FirefoxConfig firefoxConfig = (FirefoxConfig) element;
            firefoxConfig.setBrowserAdditionalArgs(browserArgs.getText());
        }
    }
